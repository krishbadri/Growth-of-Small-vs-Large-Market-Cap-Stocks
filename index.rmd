...
top_stocks_combined["Name"] = apple_list
...
#{
#  top_stocks_combined["Name"][[length(top_stocks_combined["Name"] + #1)]] = n
#}

#print(top_stocks_combined["Name"])


#top_10_plot <- top_stocks_combined |> ggplot(data=top_stocks_combined, mapping = aes(x = Date, y = Open)) + geom_point(size=0.4) + geom_smooth(se=TRUE)
#top_10_plot
